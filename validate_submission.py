#!/usr/bin/env python3
"""
Check whether a submission CSV follows the challenge rules.

Expected file:
- exactly 100 candidate rows
- columns: candidate_id, rank, score, reasoning
- ranks from 1 to 100
- scores must go down or stay equal as rank increases
"""
...
def validate_submission(csv_path):
    ...
    try:
        with open(path, "r", encoding="utf-8", newline="") as f:
            ...
            # Header must be exactly right, including column order.
